...
class DirectPurchasePortal(http.Controller):
    ...
    def _get_units(self):
        package_model = request.env["direct_purchase.procurement_package"].sudo()
    ...
    def portal_dashboard(self, **params):
        ...
        return request.render(
            "direct_purchase.portal_dashboard",
            {
                "packages": packages,
            },
        )
    ...
    def portal_packages(self, **params):
        ...
        return request.render(
            "direct_purchase.portal_packages",
            {
                "packages": packages,
                "filters": params,
                "procurement_types": self._get_selection(
                    "direct_purchase.procurement_package", "procurement_type"
                ),
                "statuses": self._get_selection(
                    "direct_purchase.procurement_package", "status"
                ),
    ...
    def portal_contracts(self, **params):
        ...
        return request.render(
            "direct_purchase.portal_contracts",
            {
                ...
                "statuses": self._get_selection("direct_purchase.contract", "status"),
            },
        )
